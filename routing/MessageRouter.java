...
public abstract class MessageRouter {
    ...
    public MessageRouter(Settings s) {
        ...
        if (s.contains(B_SIZE_S)) {
          ...
          //  this.bufferSize = Long.parseLong(B_SIZE_S);
          //  this.bufferSize = Integer.parseInt(B_SIZE_S);
            
        }
        if (s.contains(C_SIZE_S)) {
            this.cacheSize = s.getLong(C_SIZE_S);
         //   this.cacheSize = Long.parseLong(C_SIZE_S);
         //   this.cacheSize = Integer.parseInt(C_SIZE_S);
        }
    ...
    public Message messageTransferred(String id, DTNHost from) {
        ...
        if (aMessage.getTo() != null) {
            ...
            for (MessageListener ml : this.mListeners) {
              ...
              //  MessageContentStatsModifReport report = (MessageContentStatsModifReport) ml;
